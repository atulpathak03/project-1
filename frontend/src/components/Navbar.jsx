...
const Navbar = () => {
  ...
  return (
    <div className='flex item-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        <img className='w-44 cursor-pointer' src={assets.top} alt=''/>
        ...
        <div className=' flex items-center gap-4'>
            {
                ...
                <div className='flex items-center gap-2 cursor-pointer group realtive'>
                    ...
                    <div className='absolute top-8 right-9 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                        <div className='min-w-48 bg-stone-100 rounded flex flex-col gp-4 p-4'>
